...
st.markdown("TTS Filosundaki gemilerin canlı konumlarını VesselFinder üzerinden takip edin, elektrik arızaları ve denetim bulgularını kaydedin.")
...
# Ana Sekmeler
tab1, tab2, tab3 = st.tabs(["🗺️ VesselFinder Canlı Harita", "📋 Enspeksiyon Bulguları & Fotoğraf", "🚢 TTS Resmi Filo Künyesi"])
...
with tab1:
    ...
    with col_btn1:
        ...
        st.link_button(f"🌐 {gemi_adi} VesselFinder'da Aç", vf_link, type="primary")

    # VesselFinder Engelsiz Canlı Harita İframe Entegrasyonu
    vf_embed_html = f"""
    <iframe 
        width="100%" 
        height="650" 
        frameborder="0" 
        src="https://www.vesselfinder.com/aismap?zoom=3&lat=20&lon=30&width=100%25&height=650&names=true&imo={secili_gemi_bilgi['IMO']}&track=true">
    </iframe>
    """
    components.html(vf_embed_html, height=670)
